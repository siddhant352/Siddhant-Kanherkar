...
apiRouter.post("/admin/simple-login", (req, res) => {
...
apiRouter.post("/auth/login", requireAuth, async (req: AuthRequest, res) => {
  try {
...
apiRouter.post("/admin/reviews", requireAuth, requireAdmin, async (req, res) => {
  try {
...
apiRouter.get("/reviews/approved", async (req, res) => {
  try {
...
// Admin routes
apiRouter.get("/admin/dashboard", requireAuth, requireAdmin, async (req, res) => {
  try {
...
apiRouter.put("/admin/appointments/:id", requireAuth, requireAdmin, async (req, res) => {
  try {
...
apiRouter.put("/admin/reviews/:id/approve", requireAuth, requireAdmin, async (req, res) => {
  try {
...
apiRouter.delete("/admin/reviews/:id", requireAuth, requireAdmin, async (req, res) => {
  try {
